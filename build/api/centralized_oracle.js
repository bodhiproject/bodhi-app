...
var GAS_LIMIT_SET_RESULT = 1500000;
...
var CentralizedOracle = {
  bet: function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(args) {
      var contractAddress, index, amount, senderAddress, contract;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              contractAddress = args.contractAddress, index = args.index, amount = args.amount, senderAddress = args.senderAddress;
            ...
            case 5:
              if (!_lodash2.default.isUndefined(amount)) {
                _context.next = 7;
                break;
              }
            ...
            case 9:
              ...
              return _context.abrupt('return', contract.send('bet', {
                methodArgs: [index],
                amount: amount,
  ...
  setResult: function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(args) {
      var contractAddress, resultIndex, senderAddress, contract;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              contractAddress = args.contractAddress, resultIndex = args.resultIndex, senderAddress = args.senderAddress;
            ...
            case 7:
              contract = getContract(contractAddress);
              return _context2.abrupt('return', contract.send('setResult', {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              contract = getContract(contractAddress);
              return _context3.abrupt('return', contract.call('oracle', {
                methodArgs: [],
                senderAddress: senderAddress
              }));
  ...
  bettingStartBlock: function () {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              contract = getContract(contractAddress);
              return _context4.abrupt('return', contract.call('bettingStartBlock', {
                methodArgs: [],
                senderAddress: senderAddress
              }));
    ...
    function bettingStartBlock(_x4) {
      return _ref4.apply(this, arguments);
    }

    return bettingStartBlock;
  }(),
  bettingEndBlock: function () {
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 5:
              contract = getContract(contractAddress);
              return _context5.abrupt('return', contract.call('bettingEndBlock', {
                methodArgs: [],
                senderAddress: senderAddress
              }));
    ...
    function bettingEndBlock(_x5) {
      return _ref5.apply(this, arguments);
    }

    return bettingEndBlock;
  }(),
  resultSettingStartBlock: function () {
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 5:
              contract = getContract(contractAddress);
              return _context6.abrupt('return', contract.call('resultSettingStartBlock', {
                methodArgs: [],
                senderAddress: senderAddress
              }));
    ...
    function resultSettingStartBlock(_x6) {
      return _ref6.apply(this, arguments);
    }

    return resultSettingStartBlock;
  }(),
  resultSettingEndBlock: function () {
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 5:
              contract = getContract(contractAddress);
              return _context7.abrupt('return', contract.call('resultSettingEndBlock', {
                methodArgs: [],
                senderAddress: senderAddress
              }));
    ...
    function resultSettingEndBlock(_x7) {
      return _ref7.apply(this, arguments);
    }

    return resultSettingEndBlock;
  }()
};
